...
void SequenceMovement::setNewSequence(std::string name){
  if(name == "LAROUND"){
    ...
    */
    ...
    pose0.setTarget(rlj6, 0);
    Pose pose1;
    pose1.setTarget(hj1, 0);
    pose1.setTarget(hj2, 45);
    pose1.setTarget(laj1, 0);
    pose1.setTarget(raj1, 0);
    pose1.setTarget(laj2, 0);
    pose1.setTarget(raj2, 0);
    pose1.setTarget(laj3, 0);
    ...
    pose1.setTarget(llj3, 0);
    pose1.setTarget(rlj3, 0);
    pose1.setTarget(llj4, 0);
    pose1.setTarget(rlj4, 0);
    pose1.setTarget(llj5, 0);
    pose1.setTarget(rlj5, 0);
    pose1.setTarget(llj6, 0);
    pose1.setTarget(rlj6, 0);
    Pose pose2;
    pose2.setTarget(hj1, 0);
    pose2.setTarget(hj2, 0);
    pose2.setTarget(laj1, 0);
    pose2.setTarget(raj1, 0);
    pose2.setTarget(laj2, 0);
    pose2.setTarget(raj2, 0);
    pose2.setTarget(laj3, 0);
    pose2.setTarget(raj3, 0);
    pose2.setTarget(laj4, 0);
    pose2.setTarget(raj4, 0);
    pose2.setTarget(llj1, 0);
    pose2.setTarget(rlj1, 0);
    pose2.setTarget(llj2, 0);
    pose2.setTarget(rlj2, 0);
    pose2.setTarget(llj3, 0);
    pose2.setTarget(rlj3, 0);
    pose2.setTarget(llj4, 0);
    pose2.setTarget(rlj4, 0);
    pose2.setTarget(llj5, 0);
    pose2.setTarget(rlj5, 0);
    pose2.setTarget(llj6, 0);
    pose2.setTarget(rlj6, 0);
    Sequence sequence;
    sequence.addPose(pose0);
    sequence.addPose(pose1);
    sequence.addPose(pose2);
    ...
    Pose pose0;
    pose0.setTarget(hj1, 0);
    pose0.setTarget(hj2, 2);
    pose0.setTarget(laj1, -21);
    pose0.setTarget(raj1, -21);
    pose0.setTarget(laj2, 0);
    pose0.setTarget(raj2, 0);
    pose0.setTarget(laj3, 0);
    pose0.setTarget(raj3, 0);
    pose0.setTarget(laj4, 0);
    pose0.setTarget(raj4, 0);
    pose0.setTarget(llj1, -17);
    pose0.setTarget(rlj1, -17);
    pose0.setTarget(llj2, 0);
    pose0.setTarget(rlj2, 0);
    pose0.setTarget(llj3, 43);
    pose0.setTarget(rlj3, 43);
    pose0.setTarget(llj4, -33);
    pose0.setTarget(rlj4, -33);
    pose0.setTarget(llj5, 0);
    pose0.setTarget(rlj5, 0);
    pose0.setTarget(llj6, 0);
    pose0.setTarget(rlj6, 0);
    Pose pose1;
    pose1.setTarget(hj1, 0);
    pose1.setTarget(hj2, 2);
    pose1.setTarget(laj1, -21);
    pose1.setTarget(raj1, -21);
    pose1.setTarget(laj2, 0);
    pose1.setTarget(raj2, 0);
    pose1.setTarget(laj3, 0);
    pose1.setTarget(raj3, 0);
